...
<head>
	...
	<title>Gastos varios de caja</title>
</head>
<body>
...
<div id="contenido">
	<form id="caja_Gastosvarios" action="" method="POST">
		<div class = "contenedor">
			<div class = "titulo_form">
				<a class="tituloa">Gastos varios de caja</a>
			</div>
			...
			<div class="botones_accion_form">
				<button class="primerbotoncaja" type="submit""> Nuevo Gasto vario </button>
