			...
			<div id="contenido">
					...
					<div class = "contenedor">					
						...
						<div class = "titulo_form">
							<a class="tituloa"> Editar Inscripcion </a>
						</div>
							<form action="" method="POST">
								<div class = "tabla_form">
								<table>
									<?php	foreach($this->CargarInscripcion as $c){ ?>
									...
									<tr>
										...
										<td class="campo_xxl">
											<input type="date" name="nac" id="nac" value="<?= $c["nac"] ?>" placeholder="Ingrese la Fecha de Nacimiento" required>
										</td>
									</tr>
									<tr>
										...
										<td class="campo_xxl">
											<input type="text" name="dni" id="dni" value="<?= $c["dni"] ?>" placeholder="Ingrese el DNI" required>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="campo_xxl">
											<input type="enail" name="mail" id="mail" value="<?= $c["email"] ?>" placeholder="Ingrese el Email" required>
										</td>
									<?php } ?>
								</table>
								</div>
								<div class="botones_accion_form">
									...
									<input class="primerbotoncaja" type="submit" value="Actualizar Inscripcion">
								</div>
							</form>
